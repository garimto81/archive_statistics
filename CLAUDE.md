...
**Version**: 1.29.0 | **Last Updated**: 2025-12-12
...
| 테스트 (단일) | `pytest tests/test_api.py -v` |
| 린트 자동수정 | `black app/ && isort app/` |
...
| `frontend/src/components/FolderTreeWithProgress.tsx` | 트리 UI |
...
| 버전 | 날짜 | 변경 |
|------|------|------|
| 1.29.0 | 2025-12-12 | 숨긴 항목 필터 기능 (is_hidden 필드, include_hidden API) |
