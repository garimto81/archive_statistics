...
api_router.include_router(
    work_status.router, prefix="/archiving-status", tags=["Archiving Status"]
)
# Work Status (deprecated, kept for backward compatibility)
api_router.include_router(
    work_status.router, prefix="/work-status", tags=["Work Status (Deprecated)"]
)

api_router.include_router(
    worker_stats.router, prefix="/worker-stats", tags=["Worker Stats"]
)
...
api_router.include_router(
    hands.router, prefix="/hands", tags=["Hand Analysis (Deprecated)"]
)
...
api_router.include_router(
    folder_mapping.router, prefix="/folder-mapping", tags=["Folder Mapping"]
)
