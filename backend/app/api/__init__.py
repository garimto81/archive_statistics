...
from app.api import stats, folders, work_status, archiving_status, scan, worker_stats, sync, metadata, data_sources, progress, folder_mapping
...
# Archiving Status (preferred name - Issue #37)
api_router.include_router(archiving_status.router, prefix="/archiving-status", tags=["Archiving Status"])
